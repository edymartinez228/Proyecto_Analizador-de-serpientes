...
PRESENCE_MODEL_PATH = os.path.join(MODELS_DIR, "best_presence_model.pth")
SPECIES_MODEL_PATH = os.path.join(MODELS_DIR, "best_species_model.pth")
VENOM_MODEL_PATH = os.path.join(MODELS_DIR, "venomous_snake_model.h5")
